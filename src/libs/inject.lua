...
local function constantDump(tbl) 
  ...
  return ("%s\n> Constants %s\n"):format(findTable(tbl, "checkifgay") and "Entry Point" or "Proto[" .. protoCount .. "]", Serialize(tbl)); -- Bad way to check for the main script closure ik. Plus its not good for performance
end;